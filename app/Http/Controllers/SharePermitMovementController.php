...
use App\Services\SharePermitMovementService;
use Barryvdh\DomPDF\Facade as PDF;
use App\Http\Requests\BankValidator;

class SharePermitMovementController extends Controller
{
    public function __construct(SharePermitMovementService $service)
	{
